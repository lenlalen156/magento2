...
define([
    ...
    $.widget('mage.zoom', {
        options: {
            ...
            controls: {
                lens: {
                    template: '[data-templates=zoom-lens]',
                    opacity: 0.7,
                    background: '#ffffff'
                },
                track: {
                    template: '[data-templates=zoom-track]'
                },
                display: {
                    template: '[data-templates=zoom-display]',
                    width: 400,
                    height: 400,
                    left: 0,
                    top: 0
                ...
                notice: {
                    template: '[data-templates=notice]',
                    text: null,
        ...
        _renderLargeImage: function () {
            ...
            // No need to create templates just for img tag
            this.largeImage = $('<img />', {
